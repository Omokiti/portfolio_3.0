        ...
        <div className="contain" id={theme}>
         ...
         <footer className="footer space">
          <div className="footer_container">
            ...
            <p>Emamuzo Omokiti</p>
            <a href="#aboutme" className="footernav"><span className="small_nav">About</span> </a> <a href="https://canva.link/t180k2vgz3z6ktx" className="footernav"><span className="small_nav">Resume</span></a>
